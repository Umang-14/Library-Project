...
public class AdminHomeFrame extends JFrame {
    ...
    public AdminHomeFrame(String username) {
        ...
        maintenanceBtn.addActionListener(e -> {
            dispose();
            new MaintenanceFrame(username, true).setVisible(true);
        });
        reportsBtn.addActionListener(e -> {
            dispose();
            new ReportsFrame(username, true).setVisible(true);
        });
        transactionsBtn.addActionListener(e -> {
            dispose();
            new TransactionsFrame(username, true).setVisible(true);
        });
