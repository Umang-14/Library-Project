...
public class ReturnBookFrame extends JFrame {
    ...
    public ReturnBookFrame(String username, boolean isAdmin) {
        ...
        gbc.gridx = 1;
        String[] issuedBooks = DataStore.activeIssues.stream().map(i -> i[1]).distinct().toArray(String[]::new);
        ...
        bookCombo.addActionListener(e -> {
            ...
            if (selected != null && !selected.isEmpty()) {
                ...
                if (book != null) authorField.setText(book[2]);
        ...
        cancelBtn.addActionListener(e -> { dispose(); new TransactionsFrame(username, isAdmin).setVisible(true); });
